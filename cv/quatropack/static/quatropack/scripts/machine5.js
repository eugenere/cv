...
function handle_3d() {
    ...
    BABYLON.SceneLoader.ImportMesh(["Cube",], "/static/quatropack/models/", "ss.gltf", scene,         
...
function handle_3d_2() {
    ...
    BABYLON.SceneLoader.ImportMesh(["Cube",], "/static/quatropack/models/", "ss_75.gltf", scene,         
        function (meshes, particleSystems, skeletons) {
            MAIN_MESH = meshes[0]
            engine.runRenderLoop(function() {
                scene.render();
...
function handle_3d_3() {
    ...
    BABYLON.SceneLoader.ImportMesh(["cap", "base"], "/static/quatropack/models/", "bottle.gltf", scene,         
        function (meshes, particleSystems, skeletons) {
